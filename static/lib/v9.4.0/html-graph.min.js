//#region src/canvas-builder/canvas-builder-error.ts
var e = class extends Error {
	...
	graphController;
	viewportController;
	beforeDestroyEmitter;
	destroyed = !1;
	onBeforeDestroy;
	constructor(e, t, r, i) {
		this.graph = e, this.viewport = t, this.graphController = r, this.viewportController = i, [this.beforeDestroyEmitter, this.onBeforeDestroy] = n();
	}
	addNode(e) {
	...
	constructor(e) {
		this.host = e, [this.afterUpdateEmitter, this.onAfterUpdated] = n(), [this.beforeUpdateEmitter, this.onBeforeUpdated] = n(), [this.afterResizeEmitter, this.onAfterResize] = n(), this.observer.observe(this.host);
	}
	getViewportMatrix() {
	...
	patchViewportMatrix(e) {
		...
		}, this.beforeUpdateEmitter.emit(), this.contentMatrix = i(this.viewportMatrix), this.afterUpdateEmitter.emit();
	}
	patchContentMatrix(e) {
		this.contentMatrix = {
		...
		}, this.beforeUpdateEmitter.emit(), this.viewportMatrix = i(this.contentMatrix), this.afterUpdateEmitter.emit();
	}
	getDimensions() {
		let { width: e, height: t } = this.host.getBoundingClientRect();
		return {
			width: e,
			height: t
		};
	...
	createContentCoords(e) {
		return o(this.viewportMatrix, e);
	}
	createViewportCoords(e) {
		return o(this.contentMatrix, e);
	}
	destroy() {
		this.observer.disconnect();
	}
}, c = class {
	singleToMultiMap = /* @__PURE__ */ new Map();
	multiToSingleMap = /* @__PURE__ */ new Map();
	addRecord(e, t) {
		let n = this.singleToMultiMap.get(e);
		n === void 0 ? this.singleToMultiMap.set(e, /* @__PURE__ */ new Set([t])) : n.add(t), this.multiToSingleMap.set(t, e);
	}
	getMultiBySingle(e) {
		let t = this.singleToMultiMap.get(e) ?? /* @__PURE__ */ new Set();
		return Array.from(t.values());
	}
	removeByMulti(e) {
		let t = this.multiToSingleMap.get(e), n = this.singleToMultiMap.get(t);
		n.delete(e), n.size === 0 && this.singleToMultiMap.delete(t), this.multiToSingleMap.delete(e);
	}
	getByMulti(e) {
		return this.multiToSingleMap.get(e);
	}
	removeBySingle(e) {
		this.singleToMultiMap.get(e).forEach((e) => {
			this.multiToSingleMap.delete(e);
	...
	forEachSingle(e) {
		this.singleToMultiMap.forEach((t, n) => {
			e(n);
		});
	}
	hasSingle(e) {
	...
	accessNonexistingNode: (e) => `Failed to access node with ID ${JSON.stringify(e)} because it does not exist`,
	addNodeWithExistingId: (e) => `Failed to add node with ID ${JSON.stringify(e)} because a node with this ID already exists`,
	addNodeWithElementInUse: (e, t) => `Failed to add node with ID ${JSON.stringify(e)} because its HTML element is already attached to node with ID ${JSON.stringify(t)}`,
	updateNonexistentNode: (e) => `Failed to update node with ID ${JSON.stringify(e)} because it does not exist`,
	removeNonexistentNode: (e) => `Failed to remove node with ID ${JSON.stringify(e)} because it does not exist`,
	accessNonexistentPort: (e) => `Failed to access port with ID ${JSON.stringify(e)} because it does not exist`,
	addPortWithExistingId: (e) => `Failed to add port with ID ${JSON.stringify(e)} because a port with this ID already exists`,
	addPortToNonexistentNode: (e, t) => `Failed to add port with ID ${JSON.stringify(e)} to node with ID ${JSON.stringify(t)} because the node does not exist`,
	updateNonexistentPort: (e) => `Failed to update port with ID ${JSON.stringify(e)} because it does not exist`,
	accessPortsOfNonexistentNode: (e) => `Failed to access ports of node with ID ${JSON.stringify(e)} because the node does not exist`,
	removeNonexistentPort: (e) => `Failed to remove port with ID ${JSON.stringify(e)} because it does not exist`,
	accessNonexistentEdge: (e) => `Failed to access edge with ID ${JSON.stringify(e)} because it does not exist`,
	addEdgeWithExistingId: (e) => `Failed to add edge with ID ${JSON.stringify(e)} because an edge with this ID already exists`,
	addEdgeWithElementInUse: (e, t) => `Failed to add edge with ID ${JSON.stringify(e)} because its element is already attached to edge with ID ${JSON.stringify(t)}`,
	addEdgeFromNonexistentPort: (e, t) => `Failed to add edge with ID ${JSON.stringify(e)} from port with ID ${JSON.stringify(t)} because the port does not exist`,
	addEdgeToNonexistentPort: (e, t) => `Failed to add edge with ID ${JSON.stringify(e)} to port with ID ${JSON.stringify(t)} because the port does not exist`,
	updateNonexistentEdge: (e) => `Failed to update edge with ID ${JSON.stringify(e)} because it does not exist`,
	updateNonexistentEdgeSource: (e, t) => `Failed to update source of edge with ID ${JSON.stringify(e)} because source port with ID ${JSON.stringify(t)} does not exist`,
	updateNonexistentEdgeTarget: (e, t) => `Failed to update target of edge with ID ${JSON.stringify(e)} because target port with ID ${JSON.stringify(t)} does not exist`,
	removeNonexistentEdge: (e) => `Failed to remove edge with ID ${JSON.stringify(e)} because it does not exist`,
	accessEdgesForNonexistentPort: (e) => `Failed to access edges for port with ID ${JSON.stringify(e)} because the port does not exist`
}), d = class {
	nodes = /* @__PURE__ */ new Map();
	ports = /* @__PURE__ */ new Map();
	edges = /* @__PURE__ */ new Map();
	nodesElementsMap = /* @__PURE__ */ new Map();
	portIncomingEdges = /* @__PURE__ */ new Map();
	portOutgoingEdges = /* @__PURE__ */ new Map();
	portCycleEdges = /* @__PURE__ */ new Map();
	elementPorts = new c();
	edgesElementsMap = /* @__PURE__ */ new Map();
	afterNodeAddedEmitter;
	onAfterNodeAdded;
	afterNodeUpdatedEmitter;
	onAfterNodeUpdated;
	afterNodePriorityUpdatedEmitter;
	onAfterNodePriorityUpdated;
	beforeNodeRemovedEmitter;
	onBeforeNodeRemoved;
	afterPortAddedEmitter;
	onAfterPortAdded;
	afterPortUpdatedEmitter;
	onAfterPortUpdated;
	beforePortRemovedEmitter;
	onBeforePortRemoved;
	afterEdgeAddedEmitter;
	onAfterEdgeAdded;
	afterEdgeShapeUpdatedEmitter;
	onAfterEdgeShapeUpdated;
	afterEdgeUpdatedEmitter;
	onAfterEdgeUpdated;
	afterEdgePriorityUpdatedEmitter;
	onAfterEdgePriorityUpdated;
	beforeEdgeRemovedEmitter;
	onBeforeEdgeRemoved;
	beforeClearEmitter;
	onBeforeClear;
	constructor() {
		[this.afterNodeAddedEmitter, this.onAfterNodeAdded] = n(), [this.afterNodeUpdatedEmitter, this.onAfterNodeUpdated] = n(), [this.afterNodePriorityUpdatedEmitter, this.onAfterNodePriorityUpdated] = n(), [this.beforeNodeRemovedEmitter, this.onBeforeNodeRemoved] = n(), [this.afterPortAddedEmitter, this.onAfterPortAdded] = n(), [this.afterPortUpdatedEmitter, this.onAfterPortUpdated] = n(), [this.beforePortRemovedEmitter, this.onBeforePortRemoved] = n(), [this.afterEdgeAddedEmitter, this.onAfterEdgeAdded] = n(), [this.afterEdgeShapeUpdatedEmitter, this.onAfterEdgeShapeUpdated] = n(), [this.afterEdgeUpdatedEmitter, this.onAfterEdgeUpdated] = n(), [this.afterEdgePriorityUpdatedEmitter, this.onAfterEdgePriorityUpdated] = n(), [this.beforeEdgeRemovedEmitter, this.onBeforeEdgeRemoved] = n(), [this.beforeClearEmitter, this.onBeforeClear] = n();
	}
	hasNode(e) {
	...
	getNode(e) {
		...
		if (t === void 0) throw new l(u.accessNonexistingNode(e));
		return t;
	}
	addNode(e) {
		if (this.hasNode(e.id)) throw new l(u.addNodeWithExistingId(e.id));
		let t = this.findNodeIdByElement(e.element);
		if (t !== void 0) throw new l(u.addNodeWithElementInUse(e.id, t));
		...
		this.nodes.set(e.id, r), this.nodesElementsMap.set(e.element, e.id), this.afterNodeAddedEmitter.emit(e.id);
	}
	getAllNodeIds() {
	...
	updateNode(e, t) {
		if (!this.hasNode(e)) throw new l(u.updateNonexistentNode(e));
		let { payload: n } = this.nodes.get(e);
		n.x = t.x ?? n.x, n.y = t.y ?? n.y, n.centerFn = t.centerFn ?? n.centerFn, t.priority !== void 0 && (n.priority = t.priority, this.afterNodePriorityUpdatedEmitter.emit(e)), this.afterNodeUpdatedEmitter.emit(e);
	}
	removeNode(e) {
		if (!this.hasNode(e)) throw new l(u.removeNonexistentNode(e));
	...
	getPort(e) {
		let t = this.ports.get(e);
		if (t === void 0) throw new l(u.accessNonexistentPort(e));
		return t;
	}
	addPort(e) {
		if (this.hasPort(e.id)) throw new l(u.addPortWithExistingId(e.id));
		if (!this.hasNode(e.nodeId)) throw new l(u.addPortToNonexistentNode(e.id, e.nodeId));
		this.ports.set(e.id, {
			element: e.element,
	...
	updatePort(e, t) {
		if (!this.hasPort(e)) throw new l(u.updateNonexistentPort(e));
		let n = this.getPort(e).payload;
		n.direction = t.direction ?? n.direction, this.afterPortUpdatedEmitter.emit(e);
	}
	getAllPortIds() {
	...
	getNodePortIds(e) {
		let t = this.nodes.get(e);
		if (t === void 0) throw new l(u.accessPortsOfNonexistentNode(e));
		return Array.from(t.ports.keys());
	}
	removePort(e) {
		if (!this.hasPort(e)) throw new l(u.removeNonexistentPort(e));
		let t = this.getPort(e).nodeId;
	...
	getEdge(e) {
		let t = this.edges.get(e);
		if (t === void 0) throw new l(u.accessNonexistentEdge(e));
		return t;
	}
	...
	addEdge(e) {
		if (this.hasEdge(e.id)) throw new l(u.addEdgeWithExistingId(e.id));
		if (!this.hasPort(e.from)) throw new l(u.addEdgeFromNonexistentPort(e.id, e.from));
		if (!this.hasPort(e.to)) throw new l(u.addEdgeToNonexistentPort(e.id, e.to));
		let t = this.findEdgeIdByElement(e.shape.element);
		if (t !== void 0) throw new l(u.addEdgeWithElementInUse(e.id, t));
		this.addEdgeInternal(e), this.afterEdgeAddedEmitter.emit(e.id);
	}
	updateEdge(e, t) {
		if (!this.hasEdge(e)) throw new l(u.updateNonexistentEdge(e));
		if (t.from !== void 0 || t.to !== void 0) {
			if (t.from !== void 0 && !this.hasPort(t.from)) throw new l(u.updateNonexistentEdgeSource(e, t.from));
			if (t.to !== void 0 && !this.hasPort(t.to)) throw new l(u.updateNonexistentEdgeTarget(e, t.to));
	...
	removeEdge(e) {
		if (!this.hasEdge(e)) throw new l(u.removeNonexistentEdge(e));
	...
	getPortIncomingEdgeIds(e) {
		let t = this.portIncomingEdges.get(e);
		if (t === void 0) throw new l(u.accessEdgesForNonexistentPort(e));
		return Array.from(t);
	}
	getPortOutgoingEdgeIds(e) {
		let t = this.portOutgoingEdges.get(e);
		if (t === void 0) throw new l(u.accessEdgesForNonexistentPort(e));
		return Array.from(t);
	}
	getPortCycleEdgeIds(e) {
		let t = this.portCycleEdges.get(e);
		if (t === void 0) throw new l(u.accessEdgesForNonexistentPort(e));
		return Array.from(t);
	}
	...
	getNodeIncomingEdgeIds(e) {
		let t = Array.from(this.getNode(e).ports.keys()), n = [];
		return t.forEach((t) => {
			this.getPortIncomingEdgeIds(t).filter((t) => {
				let n = this.getEdge(t);
	...
	getNodeOutgoingEdgeIds(e) {
		let t = Array.from(this.getNode(e).ports.keys()), n = [];
		return t.forEach((t) => {
			this.getPortOutgoingEdgeIds(t).filter((t) => {
				let n = this.getEdge(t);
	...
	getNodeCycleEdgeIds(e) {
		let t = Array.from(this.getNode(e).ports.keys()), n = [];
		return t.forEach((t) => {
			this.getPortCycleEdgeIds(t).forEach((e) => {
				n.push(e);
			}), this.getPortIncomingEdgeIds(t).filter((t) => {
				let n = this.getEdge(t);
				return this.getPort(n.to).nodeId === e;
	...
	getNodeAdjacentEdgeIds(e) {
		let t = Array.from(this.getNode(e).ports.keys()), n = [];
		return t.forEach((e) => {
			this.getPortIncomingEdgeIds(e).forEach((e) => {
				n.push(e);
			}), this.getPortOutgoingEdgeIds(e).forEach((e) => {
				n.push(e);
			}), this.getPortCycleEdgeIds(e).forEach((e) => {
				n.push(e);
			});
		}), n;
	}
	...
	background = p(0);
	main = p(1);
	overlayConnectablePorts = m(1);
	overlayDraggableEdges = m(1);
	overlayRectangularSelection = m(2);
	host = f();
	constructor(e) {
	...
	let n = v, r = v, i = y();
	return e === "incremental" && (n = i), t === "incremental" && (r = i), typeof e == "number" && (n = _(e)), typeof t == "number" && (r = _(t)), typeof e == "function" && (n = e), typeof t == "function" && (r = t), {
		nodesPriorityFn: n,
		edgesPriorityFn: r
	};
}, x = Object.freeze({
	...
	canvas;
	elementToNodeId = /* @__PURE__ */ new Map();
	nodesResizeObserver;
	onAfterNodeAdded = (e) => {
		let t = this.canvas.graph.getNode(e);
		this.elementToNodeId.set(t.element, e), this.nodesResizeObserver.observe(t.element);
	};
	onBeforeNodeRemoved = (e) => {
		let t = this.canvas.graph.getNode(e);
	...
	constructor(e) {
		this.canvas = e, this.nodesResizeObserver = new ResizeObserver((e) => {
			e.forEach((e) => {
				let t = e.target;
				this.handleNodeResize(t);
			});
	...
	handleNodeResize(e) {
		let t = this.elementToNodeId.get(e);
		this.canvas.updateNode(t);
	}
}, ee = (e, t, n) => {
	let { x: r, y: i, width: a, height: o } = e.getBoundingClientRect();
	return t >= r && t <= r + a && n >= i && n <= i + o;
}, te = (e, t, n) => t >= 0 && t <= e.innerWidth && n >= 0 && n <= e.innerHeight, ne = class {
	element;
	win;
	constructor(e, t) {
	...
	verify(e, t) {
		return ee(this.element, e, t) && te(this.win, e, t);
	}
}, w = (e, t) => {
...
var ae = (e, t, n) => {
	...
	let r = {
		...
		x: t.x + t.width / 2,
		y: t.y + t.height / 2
	}, a = Math.min(r.x, i.x) - n, o = Math.min(r.y, i.y) - n, s = 2 * n;
	return {
		x: a,
		y: o,
		width: Math.abs(i.x - r.x) + s,
		height: Math.abs(i.y - r.y) + s,
		from: {
			x: r.x - a,
			y: r.y - o
		},
...
}, A = Object.freeze({ edgeColor: "--edge-color" }), le = (e) => {
	...
	if (e.length > 0 && n.push(`M ${e[0].x} ${e[0].y}`), e.length === 2 && n.push(`L ${e[1].x} ${e[1].y}`), e.length > 2) {
		...
		e.forEach((s, c) => {
			let l = 0, u = 0, d = 0, f = c > 0, p = c < r, m = f && p;
			if (f && (l = -i, u = -a, d = o), p) {
				let t = e[c + 1];
				i = t.x - s.x, a = t.y - s.y, o = Math.sqrt(i * i + a * a);
			}
			let h = o === 0 ? 0 : Math.min((m ? t : 0) / o, c < r - 1 ? .5 : 1), g = m ? {
				x: s.x + i * h,
				y: s.y + a * h
			} : s, _ = d === 0 ? 0 : Math.min((m ? t : 0) / d, c > 1 ? .5 : 1), v = m ? {
				x: s.x + l * _,
				y: s.y + u * _
			} : s;
			c > 0 && n.push(`L ${v.x} ${v.y}`), m && n.push(`C ${s.x} ${s.y} ${s.x} ${s.y} ${g.x} ${g.y}`);
		});
	}
	return n.join(" ");
}, fe = (e, t) => {
	...
	return n ? r ? fe(e, t) : me(e, t) : r ? he(e, t) : pe(e, t);
}, _e = class {
	path;
	midpoint;
	constructor(e) {
	...
	midpoint;
	constructor(e) {
		let { side: t, arrowLength: n, arrowOffset: r, dir: i, origin: a, hasArrow: o } = e, s = n + r, c = s + 2 * t, l = [
			{
				x: n,
				y: 0
			},
	...
	midpoint;
	constructor(e) {
		let { arrowLength: t, radius: n, smallRadius: r, dir: i, origin: a, hasArrow: o } = e, s = r + n, c = r * n / s, l = Math.sqrt(s * s - r * r), u = l * r / s, d = l + n + t, f = t + u, p = [
			{
				x: t,
				y: 0
			},
			...
			`M ${p[0].x} ${p[0].y}`,
			`A ${r} ${r} 0 0 1 ${p[1].x} ${p[1].y}`,
			`A ${n} ${n} 0 1 0 ${p[2].x} ${p[2].y}`,
			`A ${r} ${r} 0 0 1 ${p[0].x} ${p[0].y}`
	...
	return e.Line = "line", e.NodeCycle = "node-cycle", e.PortCycle = "port-cycle", e;
}({}), De = (e) => ({
	x: Math.cos(e),
	y: Math.sin(e)
}), L = class {
	...
	arrowRenderer;
	constructor(e) {
		this.params = e, [this.afterRenderEmitter, this.onAfterRender] = n(), this.arrowRenderer = this.params.arrowRenderer, this.element = le(e.color), this.element.appendChild(this.group), this.line = ue(e.width), this.group.appendChild(this.line), e.hasSourceArrow && (this.sourceArrow = j(), this.group.appendChild(this.sourceArrow)), e.hasTargetArrow && (this.targetArrow = j(), this.group.appendChild(this.targetArrow));
	}
	render(e) {
		let { x: t, y: n, width: r, height: i, from: a, to: o } = oe(e.from, e.to, this.params.padding);
		de(this.element, {
			x: t,
			y: n,
			width: r,
		...
		let s = De(e.from.direction), c = De(e.to.direction), l = {
			x: -c.x,
			y: -c.y
		}, u;
		e.category === I.PortCycle ? (u = this.params.createCyclePath, l = s) : u = e.category === I.NodeCycle ? this.params.createDetourPath : this.params.createLinePath;
		let d = u(a, o, s, c);
	...
	constructor(e) {
		this.arrowLength = e?.arrowLength ?? F.arrowLength, this.arrowOffset = e?.arrowOffset ?? F.arrowOffset, this.cycleSquareSide = e?.cycleSquareSide ?? F.cycleSquareSide;
		let t = e?.roundness ?? F.roundness;
		this.roundness = Math.min(t, this.arrowOffset, this.cycleSquareSide / 2), this.detourDistance = e?.detourDistance ?? F.detourDistance, this.hasSourceArrow = e?.hasSourceArrow ?? F.hasSourceArrow, this.hasTargetArrow = e?.hasTargetArrow ?? F.hasTargetArrow, this.pathShape = new L({
			color: e?.color ?? F.color,
			width: e?.width ?? F.width,
			arrowRenderer: R(e?.arrowRenderer ?? {}),
			arrowLength: this.arrowLength,
...
}, Ie = (e) => typeof e == "number" ? () => e : e === "box" ? Fe : e, Le = F.portOffset, z = class {
	element;
	group = document.createElementNS("http://www.w3.org/2000/svg", "g");
	line;
	sourceArrow = null;
	...
	arrowRenderer;
	constructor(e) {
		[this.afterRenderEmitter, this.onAfterRender] = n(), this.color = e?.color ?? F.color, this.width = e?.width ?? F.width, this.arrowLength = e?.arrowLength ?? F.arrowLength, this.arrowRenderer = R(e?.arrowRenderer ?? {}), this.sourceOffsetFn = Ie(e?.sourceOffset ?? Le), this.targetOffsetFn = Ie(e?.targetOffset ?? Le), this.element = le(this.color), this.element.appendChild(this.group), this.line = ue(this.width), this.group.appendChild(this.line), e?.hasSourceArrow && (this.sourceArrow = j(), this.group.appendChild(this.sourceArrow)), e?.hasTargetArrow && (this.targetArrow = j(), this.group.appendChild(this.targetArrow));
	}
	render(e) {
		let { x: t, y: n, width: r, height: i, from: a, to: o } = oe(e.from, e.to, 50);
		de(this.element, {
			x: t,
			y: n,
			width: r,
		...
		let s = o.x - a.x, c = o.y - a.y, l = Math.sqrt(s * s + c * c);
		if (l === 0) {
			this.renderEmpty(a);
			return;
		}
		let u = {
			...
			x: o.x - f * u.x,
			y: o.y - f * u.y
		}, h = this.sourceArrow === null ? 0 : this.arrowLength, g = {
			x: p.x + h * u.x,
			y: p.y + h * u.y
		}, _ = this.targetArrow === null ? 0 : this.arrowLength, v = {
			x: m.x - _ * u.x,
			y: m.y - _ * u.y
		}, y = {
			x: (p.x + m.x) / 2,
			y: (p.y + m.y) / 2
		}, b = `M ${g.x} ${g.y} L ${v.x} ${v.y}`;
		this.line.setAttribute("d", b);
		let x = null, S = null;
		if (this.sourceArrow) {
			let e = {
				x: u.x * d + a.x,
	...
	renderEmpty(e) {
		let t = null, n = null;
		this.line.setAttribute("d", ""), this.sourceArrow !== null && (t = "", this.sourceArrow.setAttribute("d", t)), this.targetArrow !== null && (n = "", this.targetArrow.setAttribute("d", n)), this.afterRenderEmitter.emit({
			edgePath: {
				path: "",
				midpoint: e
			},
	...
	constructor(t, n) {
		if (this.baseEdge = t, t instanceof e) throw new Ve("interactive edge can be configured only once");
		...
		this.interactiveLine = ze(r), this.handle.appendChild(this.interactiveLine), this.sourceArrow && (this.interactiveSourceArrow = Be(r), this.handle.appendChild(this.interactiveSourceArrow)), this.targetArrow && (this.interactiveTargetArrow = Be(r), this.handle.appendChild(this.interactiveTargetArrow)), this.group.appendChild(this.handle), this.baseEdge.onAfterRender.subscribe((e) => {
	...
	getNode(e) {
		let t = this.graphStore.getNode(e), { payload: n } = t;
		return {
			element: t.element,
			x: n.x,
			y: n.y,
	...
	getPort(e) {
		let t = this.graphStore.getPort(e);
		return {
			element: t.element,
	...
	getEdge(e) {
		let t = this.graphStore.getEdge(e), { payload: n } = t;
		return {
			from: t.from,
			to: t.to,
			priority: n.priority,
	...
	create(e) {
		...
		for (; this.checkExists(this.counter);) this.counter++;
		return this.counter;
	}
	reset() {
		this.counter = 0;
	...
	htmlView;
	params;
	nodeIdGenerator = new B((e) => this.graphStore.hasNode(e));
	portIdGenerator = new B((e) => this.graphStore.hasPort(e));
	edgeIdGenerator = new B((e) => this.graphStore.hasEdge(e));
	onAfterNodeAdded = (e) => {
		this.htmlView.attachNode(e);
	};
	onAfterNodeUpdated = (e) => {
		this.htmlView.updateNodePosition(e), this.graphStore.getNodeAdjacentEdgeIds(e).forEach((e) => {
			this.htmlView.renderEdge(e);
		});
	};
	onAfterNodePriorityUpdated = (e) => {
		this.htmlView.updateNodePriority(e);
	};
	onBeforeNodeRemoved = (e) => {
		this.graphStore.getNodePortIds(e).forEach((e) => {
			this.unmarkPort(e);
		}), this.htmlView.detachNode(e);
	};
	onAfterPortUpdated = (e) => {
		this.graphStore.getPortAdjacentEdgeIds(e).forEach((e) => {
			this.htmlView.renderEdge(e);
		});
	};
	onBeforePortUnmarked = (e) => {
		this.graphStore.getPortAdjacentEdgeIds(e).forEach((e) => {
			this.removeEdge(e);
		});
	};
	...
	onAfterEdgeShapeUpdated = (e) => {
		this.htmlView.updateEdgeShape(e);
	};
	onAfterEdgeUpdated = (e) => {
		this.htmlView.renderEdge(e);
	};
	onAfterEdgePriorityUpdated = (e) => {
	...
	constructor(e, t, n) {
		this.graphStore = e, this.htmlView = t, this.params = n, this.graphStore.onAfterNodeAdded.subscribe(this.onAfterNodeAdded), this.graphStore.onAfterNodeUpdated.subscribe(this.onAfterNodeUpdated), this.graphStore.onAfterNodePriorityUpdated.subscribe(this.onAfterNodePriorityUpdated), this.graphStore.onBeforeNodeRemoved.subscribe(this.onBeforeNodeRemoved), this.graphStore.onAfterPortUpdated.subscribe(this.onAfterPortUpdated), this.graphStore.onBeforePortRemoved.subscribe(this.onBeforePortUnmarked), this.graphStore.onAfterEdgeAdded.subscribe(this.onAfterEdgeAdded), this.graphStore.onAfterEdgeShapeUpdated.subscribe(this.onAfterEdgeShapeUpdated), this.graphStore.onAfterEdgeUpdated.subscribe(this.onAfterEdgeUpdated), this.graphStore.onAfterEdgePriorityUpdated.subscribe(this.onAfterEdgePriorityUpdated), this.graphStore.onBeforeEdgeRemoved.subscribe(this.onBeforeEdgeRemoved), this.graphStore.onBeforeClear.subscribe(this.onBeforeClear);
	}
	addNode(e) {
		let t = this.nodeIdGenerator.create(e.id);
		...
		}), e.ports !== void 0) for (let n of e.ports) this.markPort({
			id: n.id,
			element: n.element,
			nodeId: t,
	...
	markPort(e) {
		let t = this.portIdGenerator.create(e.id);
	...
	addEdge(e) {
		let t = this.edgeIdGenerator.create(e.id);
	...
	e.style.position = "absolute", e.style.top = "0", e.style.left = "0", e.style.visibility = "hidden";
}, Ye = (e) => {
	e.style.removeProperty("position"), e.style.removeProperty("top"), e.style.removeProperty("left"), e.style.removeProperty("visibility"), e.style.removeProperty("transform");
}, Xe = class {
	graphStore;
	viewportStore;
	element;
	...
	constructor(e, t, n) {
		this.graphStore = e, this.viewportStore = t, this.element = n, this.element.appendChild(this.host), this.host.appendChild(this.container), this.viewportStore.onAfterUpdated.subscribe(this.applyTransform);
	}
	attachNode(e) {
		let t = this.graphStore.getNode(e);
	...
	detachNode(e) {
		let t = this.graphStore.getNode(e);
		Ye(t.element), this.container.removeChild(t.element), this.attachedNodeIds.delete(e);
	}
	attachEdge(e) {
		let { element: t } = this.graphStore.getEdge(e).payload.shape;
	...
	updateNodePosition(e) {
		let t = this.graphStore.getNode(e), { width: n, height: r } = t.element.getBoundingClientRect(), i = this.viewportStore.getViewportMatrix().scale, { payload: a } = t, o = a.centerFn(n, r), s = a.x - i * o.x, c = a.y - i * o.y;
		t.element.style.transform = `translate(${s}px, ${c}px)`;
	}
	...
	renderEdge(e) {
		let t = this.graphStore.getEdge(e), n = this.graphStore.getPort(t.from), r = this.graphStore.getPort(t.to), i = n.element.getBoundingClientRect(), a = r.element.getBoundingClientRect(), o = this.host.getBoundingClientRect(), s = this.viewportStore.getViewportMatrix().scale, c = this.createEdgeRenderPort(n, i, o, s), l = this.createEdgeRenderPort(r, a, o, s), u = I.Line;
		n.element === r.element ? u = I.PortCycle : n.nodeId === r.nodeId && (u = I.NodeCycle), t.payload.shape.render({
			from: c,
			to: l,
			category: u
		});
	...
	hasNode(e) {
		let { x: t, y: n } = this.graphStore.getNode(e).payload;
		return t >= this.xFrom && t <= this.xTo && n >= this.yFrom && n <= this.yTo;
	}
	hasEdge(e) {
		let t = this.graphStore.getEdge(e), n = this.graphStore.getPort(t.from).nodeId, r = this.graphStore.getPort(t.to).nodeId, i = this.graphStore.getNode(n).payload, a = this.graphStore.getNode(r).payload, o = Math.min(i.x, a.x), s = Math.max(i.x, a.x), c = Math.min(i.y, a.y), l = Math.max(i.y, a.y);
		return o <= this.xTo && s >= this.xFrom && c <= this.yTo && l >= this.yFrom;
	}
}, Qe = class {
	htmlView;
	graphStore;
	trigger;
	params;
	attachedNodes = /* @__PURE__ */ new Set();
	attachedEdges = /* @__PURE__ */ new Set();
	renderingBox;
	updateViewport = (e) => {
		...
		this.graphStore.getAllNodeIds().forEach((e) => {
			let r = this.renderingBox.hasNode(e), i = this.attachedNodes.has(e);
			r && !i ? t.add(e) : !r && i && n.add(e);
		}), this.graphStore.getAllEdgeIds().forEach((e) => {
			let a = this.renderingBox.hasEdge(e), o = this.attachedEdges.has(e), s = this.graphStore.getEdge(e), c = this.graphStore.getPort(s.from).nodeId, l = this.graphStore.getPort(s.to).nodeId;
			a && (this.renderingBox.hasNode(c) || (t.add(c), n.delete(c)), this.renderingBox.hasNode(l) || (t.add(l), n.delete(l))), a && !o ? r.add(e) : !a && o && i.add(e);
		}), i.forEach((e) => {
			this.handleDetachEdge(e);
		}), n.forEach((e) => {
			this.handleDetachNode(e);
		}), t.forEach((e) => {
			this.attachedNodes.has(e) || this.handleAttachNode(e);
		}), r.forEach((e) => {
			this.handleAttachEdge(e);
		});
	};
	constructor(e, t, n, r) {
		this.htmlView = e, this.graphStore = t, this.trigger = n, this.params = r, this.renderingBox = new Ze(this.graphStore), this.trigger.subscribe(this.updateViewport);
	}
	attachNode(e) {
	...
	updateNodePosition(e) {
		this.attachedNodes.has(e) ? this.htmlView.updateNodePosition(e) : this.renderingBox.hasNode(e) && (this.handleAttachNode(e), this.graphStore.getNodeAdjacentEdgeIds(e).forEach((e) => {
	...
	attachEdgeEntities(e) {
		let t = this.graphStore.getEdge(e), n = this.graphStore.getPort(t.from).nodeId, r = this.graphStore.getPort(t.to).nodeId;
		this.attachedNodes.has(n) || this.handleAttachNode(n), this.attachedNodes.has(r) || this.handleAttachNode(r), this.handleAttachEdge(e);
	}
	handleAttachNode(e) {
	...
	htmlView;
	graphStore;
	deferredNodes = /* @__PURE__ */ new Set();
	deferredEdges = /* @__PURE__ */ new Set();
	constructor(e, t) {
	...
	isEdgeValid(e) {
		let t = this.graphStore.getEdge(e), n = this.graphStore.getPort(t.from), r = this.graphStore.getPort(t.to);
		return !(this.deferredNodes.has(n.nodeId) || this.deferredNodes.has(r.nodeId));
	}
	tryAttachEdge(e) {
	...
	win;
	constructor(e, t, n, r) {
		this.graphStore = e, this.viewportStore = t, this.params = n, this.win = r;
	}
	patchViewportMatrix(e) {
	...
	center(e, t) {
		let { width: n, height: r } = this.viewportStore.getDimensions(), i = {
			x: n / 2,
			y: r / 2
		}, a = this.viewportStore.getViewportMatrix(), o = this.viewportStore.createViewportCoords(e), s = rt(a, o.x - i.x, o.y - i.y), c = t?.contentScale;
		if (c !== void 0) {
			let e = 1 / c;
			s = it(s, e / a.scale, i.x, i.y);
		}
		let l = t?.animationDuration ?? 0;
		l > 0 ? this.animateNavigation(a, s, l) : this.viewportStore.patchViewportMatrix(s);
	}
	focus(e) {
		let t = nt(e ?? {}, this.params);
	...
	navigate(e) {
		let t = Infinity, n = -Infinity, r = Infinity, i = -Infinity, a = 0, o = /* @__PURE__ */ new Set();
		for (let t of e.nodes) o.add(t);
		if (this.graphStore.getAllNodeIds().forEach((e) => {
			let { payload: s } = this.graphStore.getNode(e);
			s.x !== null && s.y !== null && (o.size === 0 || o.has(e)) && (t = Math.min(s.x, t), n = Math.max(s.x, n), r = Math.min(s.y, r), i = Math.max(s.y, i), a++);
		}), a > 0) {
			t -= e.contentPadding, r -= e.contentPadding, n += e.contentPadding, i += e.contentPadding;
			let a = {
				x: (t + n) / 2,
				y: (r + i) / 2
			}, { scale: o } = this.viewportStore.getContentMatrix(), s = (i - r) * o, c = (n - t) * o, { width: l, height: u } = this.viewportStore.getDimensions(), d = Math.max(c / l, s / u), f = d > 1 ? o / d : o, p = Math.max(f, e.minContentScale);
			this.center(a, {
				contentScale: p,
	...
	animateNavigation(e, t, n) {
		let r, i = {
			...
			r === void 0 && (r = t);
			let o = Math.min((t - r) / n, 1);
			this.viewportStore.patchViewportMatrix({
				scale: e.scale + o * i.scale,
				x: e.x + o * i.x,
				y: e.y + o * i.y
			}), o < 1 && this.win.requestAnimationFrame(a);
		};
		this.win.requestAnimationFrame(a);
	}
}, ot = (e, t, n) => {
	let i = new d();
	return new r(new We(i), new tt(t), new Ge(i, new Xe(i, t, e), {
		nodes: {
			centerFn: g,
			priorityFn: () => 0
		},
	...
	params;
	onAfterPortMarked = (e) => {
		let t = this.canvas.graph.getPort(e);
	...
	onPortMouseDown = (e) => {
		...
		i !== null && this.params.onPointerDownVerifier(i, {
			x: t.clientX,
			y: t.clientY
		}) && (this.eventTagger.tag(e, H), this.window.addEventListener("mousemove", this.onWindowMouseMove, { passive: !0 }), this.window.addEventListener("mouseup", this.onWindowMouseUp, { passive: !0 }));
	};
	onWindowMouseMove = (e) => {
		...
		this.params.onPointerMove({
			x: e.clientX,
			y: e.clientY
		});
	};
	onWindowMouseUp = (e) => {
		this.params.mouseUpEventVerifier(e) && (this.removeWindowMouseListeners(), this.params.onPointerUp({
			x: e.clientX,
			y: e.clientY
		}));
	};
	onPortTouchStart = (e) => {
		...
		let n = t.touches[0], r = e.currentTarget, i = this.canvas.graph.findPortIdsByElement(r)[0];
		this.params.onPointerDownVerifier(i, {
			x: n.clientX,
			y: n.clientY
		}) && (this.eventTagger.tag(e, H), this.window.addEventListener("touchmove", this.onWindowTouchMove, { passive: !0 }), this.window.addEventListener("touchend", this.onWindowTouchFinish, { passive: !0 }), this.window.addEventListener("touchcancel", this.onWindowTouchFinish, { passive: !0 }));
	};
	onWindowTouchMove = (e) => {
		let t = e.touches[0];
	...
	hookPortEvents(e) {
		e.addEventListener("mousedown", this.onPortMouseDown, { passive: !0 }), e.addEventListener("touchstart", this.onPortTouchStart, { passive: !0 });
	}
	unhookPortEvents(e) {
	...
	tag(e, t) {
		let n = e, r = n[U];
		r === void 0 ? n[U] = /* @__PURE__ */ new Set([t]) : r.add(t);
	}
}, W = Symbol(), G = class {
	window;
	pointInsideVerifier;
	...
	onElementMouseDown = (e) => {
		let t = e;
		this.mouseDownEventVerifier(t) && (this.selectionCandidate = t.currentTarget, this.previousMouse = {
			x: t.clientX,
			y: t.clientY
		}, this.movedDistance = 0, this.window.addEventListener("mousemove", this.onWindowMouseMove, { passive: !0 }), this.window.addEventListener("mouseup", this.onWindowMouseUp, { passive: !0 }));
	};
	onElementTouchStart = (e) => {
		let t = e, n = t.touches;
		n.length === 1 && (this.selectionCandidate = t.currentTarget, this.previousTouch = n[0], this.movedDistance = 0, this.window.addEventListener("touchmove", this.onWindowTouchMove, { passive: !0 }), this.window.addEventListener("touchend", this.onWindowTouchEnd, { passive: !0 }), this.window.addEventListener("touchcancel", this.onWindowTouchCancel, { passive: !0 }));
	};
	onWindowMouseMove = (e) => {
		let t = e;
		if (!this.pointInsideVerifier.verify(t.clientX, t.clientY)) {
		...
		let n = this.previousMouse, r = t.clientX - n.x, i = t.clientY - n.y;
		this.previousMouse = {
			x: t.clientX,
			y: t.clientY
		}, this.processMoveThresholdVerification(r, i, () => {
			this.removeWindowMouseListeners();
		});
	};
	onWindowMouseUp = (e) => {
	...
	onWindowTouchMove = (e) => {
		...
		let n = t[0];
		if (!this.pointInsideVerifier.verify(n.clientX, n.clientY)) {
			this.removeWindowTouchListeners();
			return;
		}
		let r = this.previousTouch, i = n.clientX - r.clientX, a = n.clientY - r.clientY;
		this.previousTouch = n, this.processMoveThresholdVerification(i, a, () => {
			this.removeWindowTouchListeners();
		});
	};
	onWindowTouchEnd = (e) => {
	...
	constructor(e, t, n) {
		this.window = e, this.pointInsideVerifier = t, this.mouseDownEventVerifier = n.mouseDownEventVerifier, this.mouseUpEventVerifier = n.mouseUpEventVerifier, this.onSelected = n.onSelected, this.movementThreshold = n.movementThreshold;
	}
	enable(e) {
	...
	processMoveThresholdVerification(e, t, n) {
	...
	resolve(e) {
		...
		return this.graph.getAllPortIds().forEach((i) => {
			...
			let { top: d, left: f, width: p, height: m } = a.getBoundingClientRect(), h = {
				x: f + p / 2,
				y: d + m / 2
			}, g = r.x - h.x, _ = r.y - h.y, v = Math.sqrt(g * g + _ * _);
			v < n && (n = v, t = o);
		}), t;
	}
}, ut = class {
...
}, q = (e) => e.length > 0 ? e[0] : null, dt = class e {
	canvas;
	element;
	window;
	pointInsideVerifier;
	eventTagger;
	params;
	grabbedNodeState = null;
	maxNodePriority = 0;
	graph;
	onAfterNodeAdded = (e) => {
		this.updateMaxNodePriority(e);
		let { element: t } = this.graph.getNode(e);
		t.addEventListener("mousedown", this.onMouseDown, { passive: !0 }), t.addEventListener("touchstart", this.onTouchStart, { passive: !0 });
	};
	onAfterNodeUpdated = (e) => {
		this.updateMaxNodePriority(e);
	};
	...
	onTouchStart = (e) => {
		...
		this.grabbedNodeState = {
			...
			dx: o.x - a.x,
			dy: o.y - a.y
		}, this.moveNodeOnTop(i), this.window.addEventListener("touchmove", this.onWindowTouchMove, { passive: !0 }), this.window.addEventListener("touchend", this.onWindowTouchFinish, { passive: !0 }), this.window.addEventListener("touchcancel", this.onWindowTouchFinish, { passive: !0 });
	};
	onWindowMouseMove = (e) => {
		if (!this.pointInsideVerifier.verify(e.clientX, e.clientY)) {
			this.stopMouseDrag();
	...
	moveNodeOnTop(e) {
		if (this.params.moveOnTop) {
			if (this.maxNodePriority++, this.params.moveEdgesOnTop) {
				let t = this.maxNodePriority;
				this.maxNodePriority++, this.graph.getNodeAdjacentEdgeIds(e).forEach((e) => {
					this.canvas.updateEdge(e, { priority: t });
				});
			}
	...
	stopTouchDrag() {
		this.finishDrag(), this.removeTouchDragListeners();
	}
	removeTouchDragListeners() {
		this.window.removeEventListener("touchmove", this.onWindowTouchMove), this.window.removeEventListener("touchend", this.onWindowTouchFinish), this.window.removeEventListener("touchcancel", this.onWindowTouchFinish);
	}
	updateMaxNodePriority(e) {
		let t = this.graph.getNode(e).priority;
	...
	adjustNodeCoords(e) {
		let t = this.params.gridSize;
		if (t !== null) {
			let n = t / 2;
			return {
				x: Math.floor((e.x + n) / t) * t,
				y: Math.floor((e.y + n) / t) * t
			};
		}
		return e;
	}
	...
	transformInProgress = !1;
	revert = () => {
		this.removeMouseDragListeners(), this.removeTouchDragListeners();
	};
	onMouseDown = (e) => {
		this.eventTagger.has(e, H) || this.params.mouseDownEventVerifier(e) && (w(this.element, this.params.shiftCursor), this.window.addEventListener("mousemove", this.onWindowMouseMove, { passive: !0 }), this.window.addEventListener("mouseup", this.onWindowMouseUp, { passive: !0 }), this.startRegisteredTransform());
	};
	onWindowMouseMove = (e) => {
		...
		let n = -e.movementX, r = -e.movementY;
		this.moveViewport(n, r);
	};
	onWindowMouseUp = (e) => {
		this.params.mouseUpEventVerifier(e) && this.stopMouseDrag();
	};
	onWheelScroll = (e) => {
		if (!this.params.mouseWheelEventVerifier(e)) return;
		let { left: t, top: n } = this.element.getBoundingClientRect(), r = e.clientX - t, i = e.clientY - n, a = 1 / (e.deltaY < 0 ? this.params.wheelSensitivity : 1 / this.params.wheelSensitivity);
		this.wheelFinishTimer === null && this.params.onTransformStarted(), this.scaleViewport(a, r, i), this.wheelFinishTimer !== null && clearTimeout(this.wheelFinishTimer), this.wheelFinishTimer = setTimeout(() => {
			this.transformInProgress || this.params.onTransformFinished(), this.wheelFinishTimer = null;
		}, this.params.scaleWheelFinishTimeout);
	};
	onTouchStart = (e) => {
		if (!this.eventTagger.has(e, H)) {
			if (this.prevTouches !== null) {
				this.prevTouches = J(e);
				return;
			}
			this.prevTouches = J(e), this.window.addEventListener("touchmove", this.onWindowTouchMove, { passive: !0 }), this.window.addEventListener("touchend", this.onWindowTouchFinish, { passive: !0 }), this.window.addEventListener("touchcancel", this.onWindowTouchFinish, { passive: !0 }), this.startRegisteredTransform();
		}
	};
	onWindowTouchMove = (e) => {
		let t = J(e);
		...
		if (t.touchesCnt === 1 || t.touchesCnt === 2) {
			let { x: e, y: n } = this.prevTouches, r = t.x - e, i = t.y - n;
			this.moveViewport(-r, -i);
		}
		if (t.touchesCnt === 2) {
			let { left: e, top: n } = this.element.getBoundingClientRect(), r = this.prevTouches.x - e, i = this.prevTouches.y - n, a = 1 / (t.scale / this.prevTouches.scale);
			this.scaleViewport(a, r, i);
		}
		this.prevTouches = t;
	};
	onWindowTouchFinish = (e) => {
		e.touches.length > 0 ? this.prevTouches = J(e) : this.stopTouchDrag();
	};
	preventWheelScaleListener = (e) => {
		e.preventDefault();
	};
	constructor(e, t, n, r, i, a) {
		this.canvas = e, this.element = t, this.window = n, this.pointInsideVerifier = r, this.eventTagger = i, this.params = a, this.element.addEventListener("wheel", this.preventWheelScaleListener, { passive: !1 }), this.viewport = e.viewport, this.handleResize(), this.viewport.onAfterResize.subscribe(() => {
			this.handleResize();
		}), this.element.addEventListener("mousedown", this.onMouseDown, { passive: !0 }), this.element.addEventListener("wheel", this.onWheelScroll, { passive: !0 }), this.element.addEventListener("touchstart", this.onTouchStart, { passive: !0 }), e.onBeforeDestroy.subscribe(this.revert);
	}
	static configure(t, n, r, i, a, o) {
		new e(t, n, r, i, a, o);
	}
	moveViewport(e, t) {
		let n = this.viewport.getViewportMatrix(), r = rt(n, e, t), { width: i, height: a } = this.viewport.getDimensions(), o = this.params.transformPreprocessor({
			prevTransform: n,
			nextTransform: r,
			viewport: {
				width: i,
	...
	scaleViewport(e, t, n) {
		let r = this.canvas.viewport.getViewportMatrix(), i = it(r, e, t, n), { width: a, height: o } = this.viewport.getDimensions(), s = this.params.transformPreprocessor({
			prevTransform: r,
			nextTransform: i,
			viewport: {
				width: a,
	...
	userTransformInProgress = !1;
	constructor(e, t, n, r, i, a, o, s) {
		this.canvas = e, this.element = t, this.window = n, this.trigger = i, this.pointInsideVerifier = a, this.params = s, this.nodeHorizontal = this.params.nodeVerticalRadius, this.nodeVertical = this.params.nodeHorizontalRadius, this.viewport = e.viewport, this.currentScale = this.viewport.getViewportMatrix().scale, this.scheduleLoadAreaAroundViewport(), this.viewport.onAfterResize.subscribe(() => {
			this.scheduleLoadAreaAroundViewport();
		});
		let c = {
			...r,
			onResizeTransformStarted: () => {
				this.userTransformInProgress = !0, r.onResizeTransformStarted();
			},
			onResizeTransformFinished: () => {
				this.userTransformInProgress = !1, r.onResizeTransformFinished();
			},
			onBeforeTransformChange: () => {
				this.userTransformInProgress = !0, r.onBeforeTransformChange();
			},
			onTransformChange: () => {
				this.userTransformInProgress = !1;
				let e = this.currentScale;
				this.currentScale = this.viewport.getViewportMatrix().scale, e !== this.currentScale && this.scheduleEnsureViewportAreaLoaded(), r.onTransformChange();
			},
			onTransformFinished: () => {
				this.scheduleLoadAreaAroundViewport(), r.onTransformFinished();
			}
		};
		ft.configure(e, this.element, this.window, this.pointInsideVerifier, o, c), this.trigger.subscribe(this.updateLoadedArea), this.canvas.viewport.onAfterUpdated.subscribe(this.onAfterViewportUpdated);
	}
	...
	scheduleEnsureViewportAreaLoaded() {
		setTimeout(() => {
			let { width: e, height: t } = this.viewport.getDimensions(), { scale: n, x: r, y: i } = this.viewport.getViewportMatrix(), a = e * n, o = t * n, s = r - this.nodeHorizontal, c = i - this.nodeVertical, l = r + a + this.nodeHorizontal, u = i + o + this.nodeVertical;
			this.loadedArea.xFrom < s && this.loadedArea.xTo > l && this.loadedArea.yFrom < c && this.loadedArea.yTo > u || this.loadAreaAroundViewport();
		});
	}
	loadAreaAroundViewport() {
		let { width: e, height: t } = this.viewport.getDimensions(), { scale: n, x: r, y: i } = this.viewport.getViewportMatrix(), a = e * n, o = t * n, s = r - a - this.nodeHorizontal, c = i - o - this.nodeVertical, l = 3 * a + 2 * this.nodeHorizontal, u = 3 * o + 2 * this.nodeVertical;
		this.trigger.emit({
			x: s,
			y: c,
			width: l,
	...
	onAfterTransformUpdated = () => {
		let e = this.canvas.viewport.getContentMatrix(), t = e.x - this.halfTileWidth * e.scale, n = e.y - this.halfTileHeight * e.scale, r = `matrix(${e.scale}, 0, 0, ${e.scale}, ${t}, ${n})`;
		this.pattern.setAttribute("patternTransform", r), this.updateVisibility();
	};
	constructor(e, t, n) {
		this.canvas = e, this.backgroundHost = n, this.tileWidth = t.tileWidth, this.tileHeight = t.tileHeight, this.halfTileWidth = this.tileWidth / 2, this.halfTileHeight = this.tileHeight / 2, this.patternContent = t.renderer, this.maxViewportScale = t.maxViewportScale;
		let r = `translate(${this.halfTileWidth}, ${this.halfTileHeight})`;
		this.patternContent.setAttribute("transform", r), this.pattern.appendChild(this.patternContent);
		let i = document.createElementNS("http://www.w3.org/2000/svg", "defs");
		i.appendChild(this.pattern), this.svg.appendChild(i), this.svg.appendChild(this.patternRenderingRectangle), this.updateDimensions(), this.canvas.viewport.onAfterResize.subscribe(() => {
	...
	updateVisibility() {
		let { scale: e } = this.canvas.viewport.getViewportMatrix(), t = e > this.maxViewportScale;
	...
	updateDimensions() {
		let { width: e, height: t } = this.canvas.viewport.getDimensions();
		if (this.svg.setAttribute("width", `${e}`), this.svg.setAttribute("height", `${t}`), this.patternRenderingRectangle.setAttribute("width", `${e}`), this.patternRenderingRectangle.setAttribute("height", `${t}`), e > 0 && t > 0) {
			let n = this.tileWidth / e, r = this.tileHeight / t;
	...
	constructor(e, t, n, r, i, a, o) {
		this.canvas = e, this.overlayLayer = t, this.viewportStore = n, this.window = r, this.pointInsideVerifier = i, this.eventTagger = a, this.params = o, this.overlayCanvas = ot(this.overlayLayer, this.viewportStore, this.window);
		let s = {
			mouseDownEventVerifier: this.params.mouseDownEventVerifier,
			mouseUpEventVerifier: this.params.mouseUpEventVerifier,
			onPointerDownVerifier: (e, t) => {
				let n = this.params.connectionTypeResolver(e);
				return n === null ? !1 : (this.grabPort(e, t, n), !0);
			},
			onPointerMove: (e) => {
				this.moveDraggingPort(e);
			},
			onPointerUp: (e) => {
				this.tryCreateConnection(e), this.resetDragState();
			},
			onPointerOutside: () => {
		...
		st.configure(this.canvas, this.window, this.pointInsideVerifier, this.eventTagger, s);
	}
	static configure(t, n, r, i, a, o, s) {
		new e(t, n, r, i, a, o, s);
	}
	grabPort(e, t, n) {
		let r = this.canvas.graph.getPort(e), i = r.element.getBoundingClientRect(), a = i.x + i.width / 2, o = i.y + i.height / 2, s = this.overlayLayer.getBoundingClientRect(), c = this.canvas.viewport.createContentCoords({
			x: a - s.x,
			y: o - s.y
		...
		let f = this.params.draggingPortDirectionResolver.resolve({
			cursor: t,
			...this.edgeInProgress
		}), p = {
	...
	tryCreateConnection(e) {
		let t = ae(this.canvas.graph, e, this.params.releasedPortIdResolver);
		if (t === null) {
			this.params.onEdgeCreationInterrupted(this.edgeInProgress);
			return;
		}
		let n = K(this.edgeInProgress, t);
	...
	moveDraggingPort(e) {
		let t = this.overlayLayer.getBoundingClientRect(), n = this.canvas.viewport.createContentCoords({
			x: e.x - t.x,
			y: e.y - t.y
		}), r = this.params.draggingPortDirectionResolver.resolve({
			cursor: e,
			...this.edgeInProgress
		});
	...
	constructor(e, t, n, r, i, a, o) {
		...
		let s = {
			mouseDownEventVerifier: this.params.mouseDownEventVerifier,
			mouseUpEventVerifier: this.params.mouseUpEventVerifier,
			onPointerDownVerifier: (e, t) => this.tryStartEdgeDragging(e, t),
			onPointerMove: (e) => {
				this.moveDraggingPort(e);
			},
			onPointerUp: (e) => {
	...
	tryStartEdgeDragging(e, t) {
		let n = this.params.draggingEdgeResolver(e);
		if (n === null) return !1;
		let r = this.canvas.graph.getEdge(n), i = e === r.from, a = e === r.to, o = i ? r.to : r.from;
		this.edgeInProgress = {
			staticPortId: o,
			isDirect: a
		};
		let s = this.canvas.graph.getPort(e), c = this.canvas.graph.getPort(o), l = c.element.getBoundingClientRect(), u = {
			x: l.x + l.width / 2,
			y: l.y + l.height / 2
		}, d = this.overlayLayer.getBoundingClientRect(), f = this.canvas.viewport.createContentCoords({
			x: u.x - d.x,
			y: u.y - d.y
	...
	moveDraggingPort(e) {
		let t = this.overlayLayer.getBoundingClientRect(), n = {
			x: e.x - t.x,
			y: e.y - t.y
		}, r = this.canvas.viewport.createContentCoords(n), i = this.params.draggingPortDirectionResolver.resolve({
			cursor: e,
			...this.edgeInProgress
		});
		this.overlayCanvas.updateNode(E.DraggingNodeId, {
	...
	tryCreateConnection(e) {
		...
		let { from: n, to: r } = K(this.edgeInProgress, t), i = this.draggingEdgePayload, a = {
			id: i.id,
			from: n,
			to: r,
			shape: i.shape,
			priority: i.priority
		}, o = this.params.connectionAllowedVerifier({
			from: n,
			to: r
		}), s = this.params.connectionPreprocessor(a);
		if (o && s !== null) this.canvas.graph.onAfterEdgeAdded.subscribe(this.onEdgeReattached), this.canvas.addEdge(s), this.canvas.graph.onAfterEdgeAdded.unsubscribe(this.onEdgeReattached);
		else {
			let e = this.draggingEdgePayload;
	...
	constructor(e, t, n) {
		this.graph = e, this.applier = t, this.defererFn = n, this.graph.onAfterNodeAdded.subscribe(() => {
			this.scheduleApply();
	...
	params;
	constructor(e, t, n) {
		this.canvas = e, this.layoutAlgorithm = t, this.params = n;
	}
	apply() {
		let e = this.layoutAlgorithm.calculateCoordinates({
			graph: this.canvas.graph,
			viewport: this.canvas.viewport
		});
		this.params.onBeforeApplied(), e.forEach((e, t) => {
			this.params.staticNodeResolver(t) || this.canvas.updateNode(t, e);
		}), this.params.onAfterApplied();
	}
}, Ct = class {
	static configure(e, t) {
		let n = t.applyOn, r = new St(e, t.algorithm, {
		...
		switch (n.type) {
			case "trigger":
				bt.configure(r, n.trigger);
				break;
			case "topologyChangeSchedule":
				xt.configure(e.graph, r, n.schedule);
				break;
		}
	}
}, wt = class {
	...
	step = (e) => {
		if (this.previousTimeStamp === void 0) this.previousTimeStamp = e;
		else {
			let t = (e - this.previousTimeStamp) / 1e3;
	...
	apply(e) {
		let t = this.layoutAlgorithm.calculateNextCoordinates({
			graph: this.canvas.graph,
			viewport: this.canvas.viewport,
			dt: e
		});
		this.params.onBeforeApplied(), t.forEach((e, t) => {
			this.params.staticNodeResolver(t) || this.canvas.updateNode(t, e);
		}), this.params.onAfterApplied();
	}
}, Et = class e {
	...
	constructor(e, t, n) {
		this.applier = new Tt(e, t.algorithm, {
			staticNodeResolver: t.staticNodeResolver,
			onBeforeApplied: t.onBeforeApplied,
			onAfterApplied: t.onAfterApplied
		}), new wt(n, this.step);
	...
	constructor(e, t, n, r, i) {
		this.canvas = e, this.window = t, this.pointInsideVerifier = n, this.eventTagger = r, this.onNodeSelected = i.onNodeSelected, this.configurator = new G(this.window, this.pointInsideVerifier, {
			onSelected: (e, t) => {
				let n = this.canvas.graph.findNodeIdByElement(e);
				this.eventTagger.tag(t, this.eventHandledTag), this.onNodeSelected(n);
			},
			movementThreshold: i.movementThreshold,
			mouseDownEventVerifier: i.mouseDownEventVerifier,
			mouseUpEventVerifier: i.mouseUpEventVerifier
	...
	constructor(e, t, n, r, i) {
		this.canvas = e, this.window = t, this.pointInsideVerifier = n, this.eventTagger = r, this.onEdgeSelected = i.onEdgeSelected, this.configurator = new G(this.window, this.pointInsideVerifier, {
			onSelected: (e, t) => {
	...
	eventHandledTag = W;
	constructor(e, t, n, r, i, a) {
		this.canvas = e, this.element = t, this.window = n, this.pointInsideVerifier = r, this.eventTagger = i, this.onCanvasSelected = a.onCanvasSelected, this.configurator = new G(this.window, this.pointInsideVerifier, {
			onSelected: (e, t) => {
	...
	onCanvasTouchStart = (e) => {
		if (this.eventTagger.has(e, H)) return;
		let t = e;
		t.touches.length === 3 && (this.updateTouchSelectionRectangle(t.touches), this.host.appendChild(this.selectionRectangleWrapper), this.win.addEventListener("touchmove", this.onWindowTouchMove, { passive: !0 }), this.win.addEventListener("touchend", this.onWindowTouchEnd, { passive: !0 }), this.win.addEventListener("touchcancel", this.onWindowTouchCancel, { passive: !0 }), this.params.onSelectionStarted());
	};
	onWindowMouseMove = (e) => {
		let t = e;
		if (!this.pointInsideVerifier.verify(t.clientX, t.clientY)) {
	...
	onWindowTouchMove = (e) => {
		let t = e;
		this.updateTouchSelectionRectangle(t.touches);
		let n = this.selectionRectangleWrapper.getBoundingClientRect();
		this.params.onSelectionChange(n);
	};
	onWindowMouseUp = (e) => {
		let t = e;
	...
	removeTouchListeners() {
		this.win.removeEventListener("touchmove", this.onWindowTouchMove), this.win.removeEventListener("touchend", this.onWindowTouchEnd), this.win.removeEventListener("touchcancel", this.onWindowTouchCancel);
	}
	finishSelection() {
	...
	updateTouchSelectionRectangle(e) {
		let t = this.mainElement.getBoundingClientRect(), n = [];
		...
		let r = Mt(n);
		this.initialContentPoint = this.canvas.viewport.createContentCoords(r.from), this.draggingViewportPoint = r.to, this.updateSelectionRectangle();
	}
}, Pt = (e, t, n) => e === "nearest-connectable-port" ? new lt(t, n) : typeof e == "number" ? new ut(e) : new ut(void 0), Y = (e) => {
	if (typeof e == "function") return e;
	switch (e.type) {
		case "straight": return () => new Me({
			color: e.color,
			width: e.width,
...
}, Ft = (e) => e.button === 0 && e.ctrlKey, X = (e) => e.button === 0, Z = (e) => e.button === 0 && !e.ctrlKey, It = (e) => {
	let t = b(e.nodes?.priority, e.edges?.priority);
	return {
		nodes: {
			centerFn: e.nodes?.centerFn ?? g,
			priorityFn: t.nodesPriorityFn
		},
		ports: { direction: e.ports?.direction ?? 0 },
		edges: {
			shapeFactory: Y(e.edges?.shape ?? {}),
	...
	constructor(e, t, n) {
		this.graph = e, this.currentCoords = t, this.dt = n.dtSec, this.nodeMass = n.nodeMass, this.edgeEquilibriumLength = n.edgeEquilibriumLength, this.edgeStiffness = n.edgeStiffness, this.distanceVectorGenerator = n.distanceVectorGenerator, this.nodeForcesApplicationStrategy = n.nodeForcesApplicationStrategy;
	}
	apply() {
		let e = 0, t = /* @__PURE__ */ new Map();
		return this.graph.getAllNodeIds().forEach((e) => {
			t.set(e, {
				x: 0,
				y: 0
			});
		}), this.nodeForcesApplicationStrategy.apply(this.currentCoords, t), this.applyEdgeForces(t), this.currentCoords.forEach((n, r) => {
			let i = t.get(r), a = {
				x: i.x / this.nodeMass * this.dt,
				y: i.y / this.nodeMass * this.dt
			};
			e = Math.max(e, Math.sqrt(a.x * a.x + a.y * a.y));
			let o = a.x * this.dt, s = a.y * this.dt;
			n.x += o, n.y += s;
		}), e;
	}
	applyEdgeForces(e) {
		this.graph.getAllEdgeIds().forEach((t) => {
			let n = this.graph.getEdge(t), r = this.graph.getPort(n.from), i = this.graph.getPort(n.to), a = this.currentCoords.get(r.nodeId), o = this.currentCoords.get(i.nodeId), s = this.distanceVectorGenerator.create(a, o), c = (s.d - this.edgeEquilibriumLength) * this.edgeStiffness, l = s.ex * c, u = s.ey * c, d = e.get(r.nodeId), f = e.get(i.nodeId);
	...
	create(e, t) {
		let n = t.x - e.x, r = t.y - e.y, i = n * n + r * r;
		if (i === 0) {
			let e = this.PI2 * this.rand();
			return {
				ex: Math.cos(e),
				ey: Math.sin(e),
				d: 0
	...
	apply(e, t) {
		let n = Array.from(t.keys()), r = n.length;
		for (let i = 0; i < r; i++) {
			let a = n[i];
			for (let o = i + 1; o < r; o++) {
				let r = n[o], i = e.get(a), s = e.get(r), c = this.distanceVectorGenerator.create(i, s), l = Bt({
					coefficient: 1,
					sourceCharge: this.nodeCharge,
					targetCharge: this.nodeCharge,
					distance: c.d,
					maxForce: this.maxForce
				}), u = l * c.ex, d = l * c.ey, f = t.get(a), p = t.get(r);
				f.x -= u, f.y -= d, p.x += u, p.y += d;
			}
		}
	}
}, Ht = (e) => {
	...
	let a = n - t, o = i - r, s = Math.max(a, o);
	return {
		centerX: (t + n) / 2,
		centerY: (r + i) / 2,
		radius: s / 2
	...
	constructor(e) {
		...
		for (; t.length > 0;) {
			...
			for (; t.length > 0;) {
				let n = t.pop();
				this.processNode(n).forEach((t) => {
					e.push(t);
				});
			}
			t = e;
		}
		this.sortedParentNodes.reverse().forEach((e) => {
			let t = 0, n = 0, r = 0, i = 0;
			e.lb !== null && (r += e.lb.totalMass, i += e.lb.totalCharge, t += e.lb.chargeCenter.x * e.lb.totalCharge, n += e.lb.chargeCenter.y * e.lb.totalCharge), e.lt !== null && (r += e.lt.totalMass, i += e.lt.totalCharge, t += e.lt.chargeCenter.x * e.lt.totalCharge, n += e.lt.chargeCenter.y * e.lt.totalCharge), e.rb !== null && (r += e.rb.totalMass, i += e.rb.totalCharge, t += e.rb.chargeCenter.x * e.rb.totalCharge, n += e.rb.chargeCenter.y * e.rb.totalCharge), e.rt !== null && (r += e.rt.totalMass, i += e.rt.totalCharge, t += e.rt.chargeCenter.x * e.rt.totalCharge, n += e.rt.chargeCenter.y * e.rt.totalCharge), e.totalMass = r, e.totalCharge = i, e.chargeCenter.x = t / i, e.chargeCenter.y = n / i;
		});
	}
	getRoot() {
		return this.root;
	...
	processNode(e) {
		if (e.nodeIds.size < 2) return this.setLeaf(e), [];
		let { centerX: t, centerY: n, radius: r } = e.box;
		if (r < this.areaRadiusThreshold) return this.setLeaf(e), [];
		this.sortedParentNodes.push(e);
		let i = /* @__PURE__ */ new Set(), a = /* @__PURE__ */ new Set(), o = /* @__PURE__ */ new Set(), s = /* @__PURE__ */ new Set(), c = r / 2;
		e.nodeIds.forEach((r) => {
			let { x: c, y: l } = this.coords.get(r);
			c < t ? l < n ? s.add(r) : o.add(r) : l < n ? a.add(r) : i.add(r), e.nodeIds.delete(r);
		});
		let l = {
			parent: e,
			lb: null,
	...
	apply(e, t) {
		...
		e.forEach((r, i) => {
			let a = this.calculateForceForNode(n.getLeaf(i), i, e), o = t.get(i);
			this.applyForce(o, a);
		});
	}
	calculateForceForNode(e, t, n) {
		let r = n.get(t), i = {
			x: 0,
			y: 0
		};
		e.nodeIds.forEach((e) => {
			if (e !== t) {
				let t = n.get(e), a = this.calculateNodeRepulsiveForce({
					sourceCharge: this.nodeCharge,
					targetCharge: this.nodeCharge,
					sourceCoords: t,
					targetCoords: r
		...
		for (; a !== null;) {
			let e = a.parent;
			if (e !== null) {
				let t = this.distanceVectorGenerator.create(e.chargeCenter, r);
				e.box.radius * 2 < t.d * this.theta ? (this.tryApplyFarForce({
					totalForce: i,
					targetCoords: r,
					target: e.lb,
					current: a
	...
	calculateExactForce(e, t, n) {
		...
		for (; i.length > 0;) {
			let e = i.pop();
			e.nodeIds.forEach((e) => {
				let i = n.get(e), a = this.calculateNodeRepulsiveForce({
					sourceCharge: this.nodeCharge,
					targetCharge: this.nodeCharge,
					sourceCoords: i,
					targetCoords: t
				...
				this.applyForce(r, a);
			}), e.lb !== null && i.push(e.lb), e.rb !== null && i.push(e.rb), e.lt !== null && i.push(e.lt), e.rt !== null && i.push(e.rt);
		}
		return r;
	}
	...
	calculateNodeRepulsiveForce(e) {
		let t = this.distanceVectorGenerator.create(e.sourceCoords, e.targetCoords), n = Bt({
	...
	tryApplyFarForce(e) {
		if (e.target !== null && e.target !== e.current) {
			let t = this.calculateApproximateForce(e.target, e.targetCoords);
			this.applyForce(e.totalForce, t);
		}
	}
	tryApplyNearForce(e) {
		if (e.target !== null && e.target !== e.current) {
			let t = this.calculateExactForce(e.target, e.targetCoords, e.nodesCoords);
			this.applyForce(e.totalForce, t);
		}
	}
}, Gt = (e) => e.theta === 0 ? new Vt({
	...
	calculateCoordinates(e) {
		let { graph: t, viewport: n } = e, r = /* @__PURE__ */ new Map(), i = t.getAllNodeIds().filter((e) => {
			let n = t.getNode(e);
			return n.x === null || n.y === null;
		}), a = Math.sqrt(i.length) * this.sparsity, { width: o, height: s } = n.getDimensions(), c = {
			x: o / 2,
			y: s / 2
		}, l = n.createContentCoords(c), u = a / 2, d = {
			x: l.x - u,
			y: l.y - u
		};
		return t.getAllNodeIds().forEach((e) => {
			let n = t.getNode(e);
			r.set(e, {
				x: n.x ?? d.x + a * this.rand(),
				y: n.y ?? d.y + a * this.rand()
			});
		}), r;
	}
}, qt = class {
	...
	stopVelocity;
	constructor(e) {
		this.maxIterations = e.maxIterations, this.dtSec = e.dtSec, this.nodeMass = e.nodeMass, this.edgeEquilibriumLength = e.edgeEquilibriumLength, this.edgeStiffness = e.edgeStiffness, this.stopVelocity = e.stopVelocity, this.distanceVectorGenerator = new zt(e.rand), this.nodeForcesApplicationStrategy = Gt({
			...
			nodeMass: e.nodeMass
		}), this.fillerLayoutAlgorithm = new Kt({
			rand: e.rand,
			sparsity: e.edgeEquilibriumLength
		});
	}
	calculateCoordinates(e) {
		let { graph: t, viewport: n } = e, r = this.fillerLayoutAlgorithm.calculateCoordinates({
			graph: t,
			viewport: n
		});
		for (let e = 0; e < this.maxIterations && !(new Rt(t, r, {
			distanceVectorGenerator: this.distanceVectorGenerator,
	...
	traverse(e) {
		...
		let r = [t];
		for (this.remainingNodeIds.delete(t.nodeId); r.length > 0;) {
			let e = [];
			r.forEach((t) => {
				n.push(t);
				let r = this.nextLayerNodesResolver({
					graph: this.graph,
					currentNodeId: t.nodeId
				});
				for (let n of r) {
					if (!this.remainingNodeIds.has(n)) continue;
					this.remainingNodeIds.delete(n);
					let r = {
						nodeId: n,
						children: /* @__PURE__ */ new Set()
					};
					t.children.add(r), e.push(r);
				}
			}), r = e;
		}
	}
	...
	generate(e) {
		let t = 0, n = [], r = e.length - 1, i = [];
		e.forEach((a, o) => {
			if (t += this.params.spaceAroundRadius, a.forEach((e, n) => {
				i[n] === void 0 ? i[n] = {
					start: t + e.start,
					end: t + e.end
				} : i[n].end = t + e.end;
			}), n.push(t), o !== r) {
				let n = e[o + 1], r = i.map((e) => ({
					start: e.start - t,
					end: e.end - t
				}));
				t += this.calculateMaxDiff(r, n);
			}
			t += this.params.spaceAroundRadius;
		});
		let a = t / 2;
		return {
			childOffsets: n.map((e) => e - a),
			subtreeSpans: i.map((e) => ({
				start: e.start - a,
				end: e.end - a
			}))
		};
	...
	constructor(e, t) {
		this.tree = e;
		let n = t.spaceAroundRadius, r = new Yt({ spaceAroundRadius: n });
		[...this.tree.sequence].reverse().forEach((e) => {
			let t = Array.from(e.children).map((e) => this.treeSpans.get(e.nodeId)), i = r.generate(t), a = 0;
			e.children.forEach((e) => {
				this.offsets.set(e.nodeId, i.childOffsets[a]), a++;
			}), this.treeSpans.set(e.nodeId, [{
				start: -n,
				end: n
			}, ...i.subtreeSpans]), e.children.forEach((e) => {
				this.treeSpans.delete(e.nodeId);
			});
	...
	calculateCoordinates(e) {
		let t = /* @__PURE__ */ new Map(), n = new Jt(e.graph, this.params.nextLayerNodesResolver).generate(), r = 0;
		return n.forEach((e) => {
			t.set(e.root.nodeId, {
				x: r,
				y: 0
			});
			let n = new Xt(e, { spaceAroundRadius: this.params.layerSpace / 2 }).generate(), i = [e.root];
			for (; i.length > 0;) {
				let e = [];
				r += this.params.layerWidth, i.forEach((i) => {
					i.children.forEach((a) => {
						let o = t.get(i.nodeId).y;
						t.set(a.nodeId, {
							y: o + n.get(a.nodeId),
							x: r
						}), e.push(a);
	...
	}), i = t.getNodeIncomingEdgeIds(n).map((e) => {
		let n = t.getEdge(e);
	...
	fillerLayoutAlgorithm;
	constructor(e) {
		this.stopVelocity = e.stopVelocity, this.maxTimeDeltaSec = e.maxTimeDeltaSec, this.nodeMass = e.nodeMass, this.edgeEquilibriumLength = e.edgeEquilibriumLength, this.edgeStiffness = e.edgeStiffness, this.distanceVectorGenerator = new zt(e.rand), this.nodeForcesApplicationStrategy = Gt({
			distanceVectorGenerator: this.distanceVectorGenerator,
			nodeCharge: e.nodeCharge,
			maxForce: e.maxForce,
			nodeForceCoefficient: e.nodeForceCoefficient,
	...
	calculateNextCoordinates(e) {
		let { graph: t, viewport: n, dt: r } = e, i = this.fillerLayoutAlgorithm.calculateCoordinates({
			graph: t,
			viewport: n
		});
		return new Rt(t, i, {
	...
	createScaleRelativeMatrix(e, t) {
		let n = this.createScaleBaseMatrix(e), r = this.createShiftBaseMatrix(t);
		return this.createRelativeTransform(n, r);
	}
	createRotateRelativeMatrix(e, t) {
		let n = this.createRotateBaseMatrix(e), r = this.createShiftBaseMatrix(t);
		return this.createRelativeTransform(n, r);
	}
	...
	switch (e) {
		...
		case "incoming": return en;
		default: return Qt;
	}
}, ln = (e) => {
	switch (e?.type) {
		case "custom": return e.instance;
		case "hierarchical": return new Zt({
			layerWidth: e.layerWidth ?? Q.hierarchicalLayout.layerWidth,
			layerSpace: e.layerSpace ?? Q.hierarchicalLayout.layerSpace,
			transform: sn(e.transform),
			nextLayerNodesResolver: cn(e.nextLayerNodesResolver)
		});
		default: {
			let t = nn(e?.seed ?? x.seed), n = rn(t[0], t[1], t[2], t[3]);
			return new qt({
				dtSec: e?.dtSec ?? x.dtSec,
				maxIterations: e?.maxIterations ?? x.maxIterations,
				rand: n,
				nodeCharge: e?.nodeCharge ?? x.nodeCharge,
				nodeMass: e?.nodeMass ?? x.nodeMass,
				edgeEquilibriumLength: e?.edgeEquilibriumLength ?? x.edgeEquilibriumLength,
				edgeStiffness: e?.edgeStiffness ?? x.edgeStiffness,
				stopVelocity: e?.stopVelocity ?? x.stopVelocity,
				maxForce: e?.maxForce ?? x.maxForce,
				nodeForceCoefficient: e?.nodeForceCoefficient ?? x.nodeForceCoefficient,
				barnesHutTheta: e?.barnesHut?.theta ?? x.barnesHutTheta,
				barnesHutAreaRadiusThreshold: e?.barnesHut?.areaRadiusThreshold ?? x.barnesHutAreaRadiusThreshold
			});
		}
	}
}, un = (e) => ({
	algorithm: ln(e?.algorithm),
	applyOn: Lt(e?.applyOn),
	staticNodeResolver: e?.staticNodeResolver ?? Q.staticNodeResolver,
	onBeforeApplied: e?.events?.onBeforeApplied ?? S,
	onAfterApplied: e?.events?.onAfterApplied ?? S
}), dn = (e) => e.applyOn.type === "topologyChangeSchedule" ? e.applyOn.schedule : V, fn = (e) => {
	let { canvasDefaults: t } = e, n = e.hasLayout ? dn(e.layoutParams) : V;
	return { focus: {
...
}, mn = (e) => e instanceof SVGElement ? e : pn(e?.radius ?? 1.5, e?.color ?? "#d8d8d8"), hn = (e) => {
	let t = e?.tileDimensions;
	return {
		tileWidth: t?.width ?? 25,
		tileHeight: t?.height ?? 25,
		renderer: mn(e?.renderer ?? {}),
		maxViewportScale: e?.maxViewportScale ?? 10
	};
}, gn = (e) => ({
	onEdgeSelected: e.onEdgeSelected,
	mouseDownEventVerifier: e.mouseDownEventVerifier ?? Z,
	mouseUpEventVerifier: e.mouseUpEventVerifier ?? X,
	...
	return {
		...
		mouseDownEventVerifier: e?.mouse?.mouseDownEventVerifier ?? Z,
		mouseUpEventVerifier: e?.mouse?.mouseUpEventVerifier ?? X,
		nodeDragVerifier: e?.nodeDragVerifier ?? (() => !0),
		onNodeDragStarted: e?.events?.onNodeDragStarted ?? S,
		onNodeDrag: e?.events?.onNodeDrag ?? S,
		onNodeDragFinished: e?.events?.onNodeDragFinished ?? S
	};
}, bn = (e, t) => ({
	...e,
	onNodeDragStarted: (n) => {
	...
	let r = e?.connectionAllowedVerifier ?? xn.connectionAllowedVerifier;
	return {
		connectionTypeResolver: e?.connectionTypeResolver ?? xn.connectionTypeResolver,
		connectionAllowedVerifier: r,
		draggingPortDirectionResolver: Pt(e?.dragPortDirection, n, r),
		edgeShapeFactory: e?.edgeShape === void 0 ? t : Y(e.edgeShape),
		connectionPreprocessor: e?.connectionPreprocessor ?? xn.connectionPreprocessor,
		mouseDownEventVerifier: e?.mouseDownEventVerifier ?? Z,
		mouseUpEventVerifier: e?.mouseUpEventVerifier ?? X,
		onAfterEdgeCreated: e?.events?.onAfterEdgeCreated ?? S,
		onEdgeCreationInterrupted: e?.events?.onEdgeCreationInterrupted ?? S,
		onEdgeCreationPrevented: e?.events?.onEdgeCreationPrevented ?? S,
		grabbedPortIdResolver: e?.grabbedPortIdResolver ?? q,
		releasedPortIdResolver: e?.releasedPortIdResolver ?? q
	};
}, Cn = Object.freeze({
	connectionAllowedVerifier: () => !0,
	connectionPreprocessor: (e) => e
	...
	}, r = e?.connectionAllowedVerifier ?? Cn.connectionAllowedVerifier;
	return {
		connectionPreprocessor: e?.connectionPreprocessor ?? Cn.connectionPreprocessor,
		connectionAllowedVerifier: r,
		mouseDownEventVerifier: e?.mouseDownEventVerifier ?? Z,
		mouseUpEventVerifier: e?.mouseUpEventVerifier ?? X,
		draggingEdgeResolver: e?.draggingEdgeResolver ?? n,
		draggingEdgeShapeFactory: e?.draggingEdgeShape === void 0 ? null : Y(e?.draggingEdgeShape),
		onAfterEdgeReattached: e?.events?.onAfterEdgeReattached ?? S,
		onEdgeReattachInterrupted: e?.events?.onEdgeReattachInterrupted ?? S,
		onEdgeReattachPrevented: e?.events?.onEdgeReattachPrevented ?? S,
		draggingPortDirectionResolver: Pt(e?.dragPortDirection, t, r),
		grabbedPortIdResolver: e?.grabbedPortIdResolver ?? q,
		releasedPortIdResolver: e?.releasedPortIdResolver ?? q
	};
}, Tn = (e) => {
	...
	return n = t === void 0 ? (e) => e.nextTransform : Array.isArray(t) ? Dn(t.map((e) => On(e))) : On(t), {
		wheelSensitivity: e?.zoom?.mouseWheelSensitivity ?? e?.scale?.mouseWheelSensitivity ?? 1.2,
		onTransformStarted: e?.events?.onTransformStarted ?? S,
		onTransformFinished: e?.events?.onTransformFinished ?? S,
		onBeforeTransformChange: e?.events?.onBeforeTransformChange ?? S,
		onTransformChange: e?.events?.onTransformChange ?? S,
		transformPreprocessor: n,
		shiftCursor: e?.pan?.cursor ?? "grab",
		mouseDownEventVerifier: e?.pan?.mouseDownEventVerifier ?? Z,
		mouseUpEventVerifier: e?.pan?.mouseUpEventVerifier ?? X,
		mouseWheelEventVerifier: e?.zoom?.mouseWheelEventVerifier ?? e?.scale?.mouseWheelEventVerifier ?? (() => !0),
		scaleWheelFinishTimeout: e?.zoom?.wheelFinishTimeout ?? e?.scale?.wheelFinishTimeout ?? 500,
		onResizeTransformStarted: e?.events?.onResizeTransformStarted ?? S,
		onResizeTransformFinished: e?.events?.onResizeTransformFinished ?? S
	};
}, An = (e) => ({
	...
	rectangleElement: e?.rectangleElement ?? jn(),
	mouseDownEventVerifier: e?.mouseDownEventVerifier ?? Ft,
	mouseUpEventVerifier: e?.mouseUpEventVerifier ?? X,
	onSelectionStarted: e?.onSelectionStarted ?? S,
	onSelectionChange: e?.onSelectionChange ?? S,
	onSelectionInterrupted: e?.onSelectionInterrupted ?? S,
	onSelectionFinished: e?.onSelectionFinished ?? S
}), Nn = (e) => {
	switch (e?.type) {
		case "custom": return e.instance;
		default: {
			let t = nn(e?.seed ?? x.seed);
			return new tn({
				rand: rn(t[0], t[1], t[2], t[3]),
				maxTimeDeltaSec: e?.maxTimeDeltaSec ?? x.maxTimeDeltaSec,
				nodeCharge: e?.nodeCharge ?? x.nodeCharge,
				nodeMass: e?.nodeMass ?? x.nodeMass,
				edgeEquilibriumLength: e?.edgeEquilibriumLength ?? x.edgeEquilibriumLength,
				edgeStiffness: e?.edgeStiffness ?? x.edgeStiffness,
...
}, Pn = { staticNodeResolver: () => !1 }, Fn = (e) => ({
	algorithm: Nn(e?.algorithm ?? {}),
	...
	onAfterNodeDetached: e?.events?.onAfterNodeDetached ?? S,
	onBeforeNodeAttached: e?.events?.onBeforeNodeAttached ?? S
}), zn = class {
	element;
	params;
	boxRenderingTrigger = new t();
	window = window;
	...
	canvas;
	constructor(e, t) {
		this.element = e, this.params = t, this.pointInsideVerifier = new ne(this.element, this.window), this.viewportStore = new s(this.element), this.layers = new h(this.element), this.htmlView = this.createHtmlView(), this.graphControllerParams = It(this.params.canvasDefaults), this.graphController = new Ge(this.graphStore, this.htmlView, this.graphControllerParams), this.layoutParams = un(this.params.layout.config);
		let n = fn({
			canvasDefaults: this.params.canvasDefaults,
			hasLayout: this.params.layout.enabled,
			layoutParams: this.layoutParams
		}), i = new at(this.graphStore, this.viewportStore, n, this.window), a = new tt(this.viewportStore), o = new We(this.graphStore);
		if (this.canvas = new r(o, a, this.graphController, i), this.params.background.enabled && _t.configure(this.canvas, hn(this.params.background.config), this.layers.background), this.params.nodeResizeReactiveEdges.enabled && C.configure(this.canvas), this.params.userSelectableEdges.enabled) {
			let e = gn(this.params.userSelectableEdges.config);
			Ot.configure(this.canvas, this.window, this.pointInsideVerifier, this.eventTagger, e);
		}
		if (this.params.userSelectableNodes.enabled) {
			let e = _n(this.params.userSelectableNodes.config);
			Dt.configure(this.canvas, this.window, this.pointInsideVerifier, this.eventTagger, e);
		}
		if (this.params.userSelectableCanvas.enabled) {
			let e = vn(this.params.userSelectableCanvas.config);
			kt.configure(this.canvas, this.layers.main, this.window, this.pointInsideVerifier, this.eventTagger, e);
		}
		if (this.params.draggableNodes.enabled) {
			let e = yn(this.params.draggableNodes.config);
			this.params.animatedLayout.enabled && (e = bn(e, this.animationStaticNodes)), dt.configure(this.canvas, this.layers.main, this.window, this.pointInsideVerifier, this.eventTagger, e);
		}
		if (this.params.userConnectablePorts.enabled) {
			let e = Sn(this.params.userConnectablePorts.config, this.graphControllerParams.edges.shapeFactory, this.canvas.graph);
			vt.configure(this.canvas, this.layers.overlayConnectablePorts, this.viewportStore, this.window, this.pointInsideVerifier, this.eventTagger, e);
		}
		if (this.params.userDraggableEdges.enabled) {
			let e = wn(this.params.userDraggableEdges.config, this.canvas.graph);
			yt.configure(this.canvas, this.layers.overlayDraggableEdges, this.viewportStore, this.window, this.pointInsideVerifier, this.eventTagger, e);
		}
		if (this.params.virtualScroll.enabled ? pt.configure(this.canvas, this.layers.main, this.window, kn(this.params.userTransformableViewport.config), this.boxRenderingTrigger, this.pointInsideVerifier, this.eventTagger, An(this.params.virtualScroll.config)) : this.params.userTransformableViewport.enabled && ft.configure(this.canvas, this.layers.main, this.window, this.pointInsideVerifier, this.eventTagger, kn(this.params.userTransformableViewport.config)), this.params.rectangularSelection.enabled && Nt.configure(this.canvas, this.layers.main, this.layers.overlayRectangularSelection, this.pointInsideVerifier, this.eventTagger, this.window, Mn(this.params.rectangularSelection.config)), this.params.layout.enabled && Ct.configure(this.canvas, this.layoutParams), this.params.animatedLayout.enabled) {
			let e = Fn(this.params.animatedLayout.config);
			this.params.draggableNodes.enabled && (In(this.canvas, this.animationStaticNodes), e = Ln(e, this.animationStaticNodes)), Et.configure(this.canvas, e, this.window);
		}
	...
	createHtmlView() {
		let e = new Xe(this.graphStore, this.viewportStore, this.layers.main);
		return this.params.virtualScroll.enabled && (e = new Qe(e, this.graphStore, this.boxRenderingTrigger, Rn(this.params.virtualScroll.config))), e = new $e(e, this.graphStore), e;
	}
}, Bn = class {
	element;
	used = !1;
	canvasDefaults = {};
	draggableNodesConfig = void 0;
	userTransformableViewportConfig = void 0;
	backgroundConfig = void 0;
	userConnectablePortsConfig = void 0;
	userDraggableEdgesConfig = void 0;
	rectangularSelectionConfig = void 0;
	virtualScrollConfig = void 0;
	layoutConfig = void 0;
	animatedLayoutConfig = void 0;
	userSelectableNodesConfig = void 0;
	userSelectableEdgesConfig = void 0;
	userSelectableCanvasConfig = void 0;
	hasDraggableNodes = !1;
	hasUserTransformableViewport = !1;
	hasNodeResizeReactiveEdges = !1;
	hasBackground = !1;
	...
	enableUserDraggableNodes(e) {
		return this.hasDraggableNodes = !0, this.draggableNodesConfig = e, this;
	}
	enableUserTransformableViewport(e) {
		return this.hasUserTransformableViewport = !0, this.userTransformableViewportConfig = e, this;
	}
	...
	enableUserConnectablePorts(e) {
		return this.hasUserConnectablePorts = !0, this.userConnectablePortsConfig = e, this;
	}
	enableUserDraggableEdges(e) {
		return this.hasUserDraggableEdges = !0, this.userDraggableEdgesConfig = e, this;
	}
	...
	build() {
		if (this.used) throw new e("Failed to build Canvas because CanvasBuilder is a single-use object");
		this.used = !0;
		let t = {
			...
			virtualScroll: this.virtualScrollConfig === void 0 ? { enabled: !1 } : {
				enabled: !0,
			...
			nodeResizeReactiveEdges: { enabled: this.hasNodeResizeReactiveEdges },
			userSelectableNodes: this.userSelectableNodesConfig === void 0 ? { enabled: !1 } : {
				enabled: !0,
				config: this.userSelectableNodesConfig
			},
			userSelectableEdges: this.userSelectableEdgesConfig === void 0 ? { enabled: !1 } : {
				enabled: !0,
				config: this.userSelectableEdgesConfig
			},
			userSelectableCanvas: this.userSelectableCanvasConfig === void 0 ? { enabled: !1 } : {
				enabled: !0,
				config: this.userSelectableCanvasConfig
			}
		};
		return new zn(this.element, t).canvas;
	}
};
//#endregion
export { je as BezierEdgeShape, Bn as CanvasBuilder, e as CanvasBuilderError, l as CanvasError, I as ConnectionCategory, z as DirectEdgeShape, t as EventSubject, Ve as InteractiveEdgeError, He as InteractiveEdgeShape, Ue as MidpointEdgeShape, Pe as OrthogonalEdgeShape, Me as StraightEdgeShape };
