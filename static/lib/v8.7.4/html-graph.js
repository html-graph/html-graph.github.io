...
const Z = Object.freeze({
  ...
  if (r.length > 0 && t.push(`M ${r[0].x} ${r[0].y}`), r.length === 2 && t.push(`L ${r[1].x} ${r[1].y}`), r.length > 2) {
    ...
    r.forEach((h, d) => {
      ...
      const E = a !== 0 ? Math.min((p ? e : 0) / a, d < s - 1 ? 0.5 : 1) : 0, b = p ? { x: h.x + o * E, y: h.y + n * E } : h, P = l !== 0 ? Math.min((p ? e : 0) / l, d > 1 ? 0.5 : 1) : 0, L = p ? { x: h.x + c * P, y: h.y + g * P } : h;
  ...
  navigate(e) {
    ...
    if (this.graphStore.getAllNodeIds().forEach((d) => {
      ...
      const d = {
        ...
        l / u,
        g / w
      ), v = p > 1 ? c / p : c, E = Math.max(v, e.minContentScale);
      this.center(d, { contentScale: E });
    }
  }
}
const ze = (r, e) => {
...
class oe {
  ...
  tryStartEdgeDragging(e, t) {
    ...
    }, [b, N] = this.isTargetDragging ? [v, E] : [E, v];
    this.overlayCanvas.addNode(O(b)), this.overlayCanvas.addNode(O(N));
...
const zt = (r) => {
  ...
  }), n = r.moveOnTop !== !1, a = r.moveEdgesOnTop !== !1 && n, h = (E = r.mouse) == null ? void 0 : E.dragCursor, d = h !== void 0 ? h : "grab", c = (b = r.mouse) == null ? void 0 : b.mouseDownEventVerifier, g = c !== void 0 ? c : (P) => P.button === 0, l = (N = r.mouse) == null ? void 0 : N.mouseUpEventVerifier, u = l !== void 0 ? l : (P) => P.button === 0;
  return {
    moveOnTop: n,
    moveEdgesOnTop: a,
    dragCursor: d,
  ...
  var p, v, E, b, N, P, L, V, de, ce, le, ge;
  ...
  }), d = (N = r == null ? void 0 : r.shift) == null ? void 0 : N.mouseDownEventVerifier, c = d !== void 0 ? d : (T) => T.button === 0, g = (P = r == null ? void 0 : r.shift) == null ? void 0 : P.mouseUpEventVerifier, l = g !== void 0 ? g : (T) => T.button === 0, u = (L = r == null ? void 0 : r.scale) == null ? void 0 : L.mouseWheelEventVerifier, w = u !== void 0 ? u : () => !0;
  return {
    wheelSensitivity: t,
  ...
  apply(e, t) {
    ...
    for (let n = 0; n < o; n++) {
      ...
      for (let h = n + 1; h < o; h++) {
        ...
        }), w = u * l.ex, p = u * l.ey, v = t.get(a), E = t.get(d);
        v.x -= w, v.y -= p, E.x += w, E.y += p;
      }
    }
  }
}
