...
To include the library into your project, the following options are available:
...
<div id="canvas"></div>
<script type="module">
  import { CanvasBuilder } from "https://unpkg.com/@html-graph/html-graph@9.1.0/dist/html-graph.min.js";
