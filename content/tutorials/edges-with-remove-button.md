---
title: Tutorials | Edges with Remove Button
---
...
const createRemoveEdgeButton = () => {
  ...
  path.setAttribute("d", "M -3 -3 L 3 3 M 3 -3 L -3 3");
  path.setAttribute("stroke", "var(--remove-color)");
...
{{< use-case src=/use-cases/midpoint-edge/ >}}
