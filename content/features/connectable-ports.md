...
| `grabbedPortIdResolver`     | `(portIds: Identifier[]) => Identifier \| null`                                        | Resolves ID of a port being grabbed when there's disambiguity                                              | no       | First added port                |
| `releasedPortIdResolver`    | `(portIds: Identifier[]) => Identifier \| null`                                        | Resolves ID of a port being released when there's disambiguity                                             | no       | First added port                |
