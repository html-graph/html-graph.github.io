...
| `connectionPreprocessor`    | `(request: AddEdgeRequest) => AddEdgeRequest`                                          | Applies modifications to the edge about to be created. `null` means that connection is disallowed.                     | no       | `(request) => request`          |
...
| `dragPortDirection`         | `number`                                                                               | Direction of dragging port                                                                                             | no       | Same as for canvas              |
