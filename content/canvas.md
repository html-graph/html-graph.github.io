...
|------------|-----------------------------------------------------|-----------------------------------------|----------|----------------------------------------------------------------------|
| `id`       | `Identifier`                                        | Unique identifier for the node          | no       | _autogenerated_                                                      |
| `element`  | `HTMLElement \| SVGSVGElement`                      | Element for the node                    | yes      |                                                                      |
...
| `centerFn` | `function`                                          | Function to determine the node's center | no       | From <a href="/defaults#nodes" target="_blank">defaults</a> |
| `priority` | `number`                                            | Z-index of the node                     | no       | From <a href="/defaults#nodes" target="_blank">defaults</a> |
...
| Name        | Type                        | Description                     | Required | Default                                                     |
|-------------|-----------------------------|---------------------------------|----------|-------------------------------------------------------------|
| `id`        | `Identifier`                | Unique identifier for the port  | no       | _autogenerated_                                             |
| `element`   | `HTMLElement \| SVGElement` | Element for the port            | yes      |                                                             |
| `direction` | `number`                    | Radian angle for edge direction | no       | From <a href="/defaults#ports" target="_blank">defaults</a> |
...
| Name            | Type                                                   | Description                      | Required | Default |
|-----------------|--------------------------------------------------------|----------------------------------|----------|---------|
| `id`            | `Identifier`                                           | Identifier of the node to update | yes      |         |
...
| Name | Type         | Description                      | Required |
|------|--------------|----------------------------------|----------|
| `id` | `Identifier` | Identifier of the node to remove | yes      |
...
|-------------|-----------------------------|---------------------------------|----------|-------------------------------------------------------------|
| `id`        | `Identifier`                | Unique identifier for the port  | no       | _autogenerated_                                             |
| `nodeId`    | `Identifier`                | Identifier of the node          | yes      |                                                             |
| `element`   | `HTMLElement \| SVGElement` | Element for the port            | yes      |                                                             |
| `direction` | `number`                    | Radian angle for edge direction | no       | From <a href="/defaults#ports" target="_blank">defaults</a> |
...
| Name            | Type                                                   | Description                      | Required | Default |
|-----------------|--------------------------------------------------------|----------------------------------|----------|---------|
| `id`            | `Identifier`                                           | Identifier of the port to update | yes      |         |
...
| Name | Type         | Description                      | Required |
|------|--------------|----------------------------------|----------|
| `id` | `Identifier` | Identifier of the port to unmark | yes      |
...
| Name       | Type                                                               | Description                    | Required | Default                                                     |
|------------|--------------------------------------------------------------------|--------------------------------|----------|-------------------------------------------------------------|
| `id`       | `Identifier`                                                       | Unique identifier for the edge | no       | _autogenerated_                                             |
| `from`     | `Identifier`                                                       | Identifier of the source port  | yes      |                                                             |
| `to`       | `Identifier`                                                       | Identifier of the target port  | yes      |                                                             |
| `shape`    | <code><a href="/edge-shapes/" target="_blank">EdgeShape</a></code> | Shape of the edge              | no       | From <a href="/defaults#edges" target="_blank">defaults</a> |
| `priority` | `number`                                                           | Z-index of the edge            | no       | From <a href="/defaults#edges" target="_blank">defaults</a> |
...
| Name            | Type                                                              | Description                      | Required | Default |
|-----------------|-------------------------------------------------------------------|----------------------------------|----------|---------|
| `id`            | `Identifier`                                                      | Identifier of the edge to update | yes      |         |
...
| Name       | Type                                                               | Description               | Required |
|------------|--------------------------------------------------------------------|---------------------------|----------|
| `from`     | `Identifier`                                                       | Identifier of source port | no       |
| `to`       | `Identifier`                                                       | Identifier of target port | no       |
...
| Name | Type         | Description                      | Required |
|------|--------------|----------------------------------|----------|
| `id` | `Identifier` | Identifier of the edge to remove | yes      |
...
When node IDs are not specified all displayed nodes are focused.
...
| Name                | Type                   | Description                                                                                                                               | Required | Default                                                     |
|---------------------|------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|----------|-------------------------------------------------------------|
| `nodes`             | `Iterable<Identifier>` | A set of node IDs to focus                                                                                                                | no       | All nodes                                                   |
...
- **X**: Measures the horizontal distance from the canvas absolute zero point to the top-left corner of the viewport on the canvas.
- **Y**: Measures the vertical distance from the canvas absolute zero point to the top-left corner of the viewport on the canvas.
...
- **X**: Measures the horizontal distance from the top-left corner of the viewport to the canvas absolute zero point on the screen.
- **Y**: Measures the vertical distance from the top-left corner of the viewport to the canvas absolute zero point on the screen.
