...
| x        | `number \| null \| undefined`                       | X-coordinate of the node                | no       | `null`                         |
| y        | `number \| null \| undefined`                       | Y-coordinate of the node                | no       | `null`                         |
...
\* Only nodes with defined coordinates are displayed.
