...
| `contentPadding`    | `number`        | This value adds extra space between viewport border and graph nodes                                                                       | no       | Configured in <a href="/defaults#focus" target="_blank">Defaults</a> |
